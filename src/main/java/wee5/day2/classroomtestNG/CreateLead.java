...
public class CreateLead extends TestNgAnnotations {
	...
	public void createLead(String cmpnname, String fname, String lname) throws InterruptedException {
		...
		driver.findElementById("createLeadForm_companyName").sendKeys(cmpnname);
...
//Verify the first name
	...
	//manually storing the data in 2d Array
	@DataProvider
